...
public record RepairOrderResponse(
    ...
    public RepairOrderResponse(RepairOrder repairOrder) {
        this(
            ...
            repairOrder.getEstimatedEmission(),
            repairOrder.getRepairType(),
            repairOrder.isEcoMaterial(),
            repairOrder.getReworkCount(),
            repairOrder.getGreenIndex(),
            repairOrder.getGreenRecommendation(),
